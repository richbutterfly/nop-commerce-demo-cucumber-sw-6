...
public class LoginSteps {
    ...
    @Then("I should see the Home page displayed with {string} message")
    public void iShouldSeeTheHomePageDisplayedWithMessage(String homepageWelcomeText) {
        Assert.assertEquals(new HomePage().getWelcomeText(), homepageWelcomeText);
    }
}
